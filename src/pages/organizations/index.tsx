...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'historical_data.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('historical_data', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'historical_data',
          header: 'Historical Data',
          accessorKey: 'historical_data',
          cell: ({ row: { original: record } }: any) => record?._count?.historical_data,
        }
      : null,
