...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Advanced Backtester`}</title>

        <meta
          name="description"
          content="Experience the power of precision with Advanced Backtester, your reliable partner for historical backtesting of FNO NSE data."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the power of precision with Advanced Backtester, your reliable partner for historical backtesting of FNO NSE data.`}
            </Text>
            <Box
